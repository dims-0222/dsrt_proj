...
C {/foss/pdks/sky130A/libs.tech/xschem/sky130_fd_pr/pfet_01v8.sym} 600 -570 0 1 {name=M3
W=0.75
L=0.5
nf=1
mult=1
...
C {/foss/pdks/sky130A/libs.tech/xschem/sky130_fd_pr/pfet_01v8.sym} 810 -570 0 0 {name=M4
W=0.75
L=0.5
nf=1
mult=1
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1010 -520 1 0 {name=C2 model=cap_mim_m3_1 W=15 L=15 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1250 -320 0 0 {name=C1 model=cap_mim_m3_1 W=32 L=32 MF=1 spiceprefix=X}
